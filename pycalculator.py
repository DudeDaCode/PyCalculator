...
tk.Label(canvas, textvariable=display_text, anchor='e', bg='black', fg='#ffffe0', font=('Cuadra',47)).grid(row=1, columnspan=4, sticky='ew', padx=4, pady=2)
